...
public abstract class OpdexMarket : SmartContract, IOpdexMarket
{
    ...
    /// <inheritdoc />
    public virtual void SwapExactCrsForSrc(UInt256 amountSrcOutMin, Address token, Address to, ulong deadline)
    {
        SwapExactCrsForSrcExecute(amountSrcOutMin, token, to, deadline);
    }

    /// <inheritdoc />
    public virtual void SwapSrcForExactCrs(ulong amountCrsOut, UInt256 amountSrcInMax, Address token, Address to, ulong deadline)
    {
        SwapSrcForExactCrsExecute(amountCrsOut, amountSrcInMax, token, to, deadline);
    }

    /// <inheritdoc />
    public virtual void SwapExactSrcForCrs(UInt256 amountSrcIn, ulong amountCrsOutMin, Address token, Address to, ulong deadline)
    {
        SwapExactSrcForCrsExecute(amountSrcIn, amountCrsOutMin, token, to, deadline);
    }

    /// <inheritdoc />
    public virtual void SwapCrsForExactSrc(UInt256 amountSrcOut, Address token, Address to, ulong deadline)
    {
        SwapCrsForExactSrcExecute(amountSrcOut, token, to, deadline);
    }

    /// <inheritdoc />
    public virtual void SwapSrcForExactSrc(UInt256 amountSrcInMax, Address tokenIn, UInt256 amountSrcOut, Address tokenOut, Address to, ulong deadline)
    {
        SwapSrcForExactSrcExecute(amountSrcInMax, tokenIn, amountSrcOut, tokenOut, to, deadline);
    }

    /// <inheritdoc />
    public virtual void SwapExactSrcForSrc(UInt256 amountSrcIn, Address tokenIn, UInt256 amountSrcOutMin, Address tokenOut, Address to, ulong deadline)
    {
    ...
    protected void SwapExactCrsForSrcExecute(UInt256 amountSrcOutMin, Address token, Address to, ulong deadline)
    {
        ValidateDeadline(deadline);
    ...
    protected void SwapSrcForExactCrsExecute(ulong amountCrsOut, UInt256 amountSrcInMax, Address token, Address to, ulong deadline)
    {
        ValidateDeadline(deadline);
    ...
    protected void SwapExactSrcForCrsExecute(UInt256 amountSrcIn, ulong amountCrsOutMin, Address token, Address to, ulong deadline)
    {
        ValidateDeadline(deadline);
    ...
    protected void SwapCrsForExactSrcExecute(UInt256 amountSrcOut, Address token, Address to, ulong deadline)
    {
        ValidateDeadline(deadline);
    ...
    protected void SwapSrcForExactSrcExecute(UInt256 amountSrcInMax, Address tokenIn, UInt256 amountSrcOut, Address tokenOut, Address to, ulong deadline)
    {
        ValidateDeadline(deadline);
    ...
    protected void SwapExactSrcForSrcExecute(UInt256 amountSrcIn, Address tokenIn, UInt256 amountSrcOutMin, Address tokenOut, Address to, ulong deadline)
    {
        ValidateDeadline(deadline);
